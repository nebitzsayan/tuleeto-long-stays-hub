      ...
      <div className="container max-w-3xl mx-auto">
        <div className="text-center mb-10">
          <div className="flex justify-center mb-4">
            {isRealEstate ? (
              <Building2 className="h-12 w-12 text-tuleeto-blue" />
            ) : (
              <Home className="h-12 w-12 text-tuleeto-orange" />
            )}
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            {isRealEstate ? 'List Property for Sale' : 'List Your Property'}
          </h1>
          <p className="text-gray-600">
            {isRealEstate 
              ? 'Fill out the form below to list your property for sale on Tuleeto'
